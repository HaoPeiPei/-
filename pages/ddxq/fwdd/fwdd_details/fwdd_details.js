...
Page({
  ...
  initData(options){
    ...
    _this.setData({
      orderId: orderId,
      qrcodeImg: wwwRoot+'/weixin/jctnew/ashx/qrcode.ashx?myact=getqrcode&orderid='+orderId
    });
  ...
  payOrder(orderId){
    var that = this;
      ...
      httpRequst.HttpRequst(true, '/weixin/miniprogram/ashx/service.ashx', { action: "pay", orderId: orderId, status: "1" }, "POST",function(res){
          wx.hideLoading()
          if (res.Success) {
              wx.showToast({
