...
Page({
  ...
  createPayPara() {
    ...
    if (orderId != null && orderId != "") {
      ...
      httpRequst.HttpRequst(true, '/weixin/miniprogram/ashx/rentcar.ashx', { action: "createwxpaypara", orderId: this.data.orderId, openId: app.globalData.openId  } , "POST",function(res){
          wx.hideLoading()
          if (res.Success) {
